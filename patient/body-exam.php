    ...
    <div class="content">
        ...
        <div class="body-page">
            ...
            <div class="w3-row w3-center">
                ...
                <p class="description-text">Click the areas of the body where you feel pain</p>
                    <!-- Human Body //-->
                    <div class="human-body">
                        <svg data-position='head' id='head' class='head' xmlns='http://www.w3.org/2000/svg'
                        ...
                        <svg data-position='chest' id='chest' class='chest' xmlns='http://www.w3.org/2000/svg'
                        ...
                        <svg data-position='right-leg' id='right-leg' class='right-leg'
                            xmlns='http://www.w3.org/2000/svg' width='80' height='250.625' viewBox='0 0 80 250.625'>
                            <path
                        ...
                        <svg data-position='left-hand' id='left-hand' class='left-hand'
                            xmlns='http://www.w3.org/2000/svg' width='90' height='38.938' viewBox='0 0 90 38.938'>
                            <path
